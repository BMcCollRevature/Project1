...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd;">
 ...
 <hr>
  ...
  <!--     <div class="form-group">
       <label for="uname">Submitted:</label> <input type="datetime-local"
        class="form-control" id="submit" placeholder="time"
        name="submitted" >
      </div>

      <div class="form-group">
       <label for="uname">Resolved:</label> <input type="datetime-local"
        class="form-control" id="resolve" placeholder="time" 
        name="resolved" >
      </div> -->
    ...
    <!--   <div class="form-group">
       <label for="uname">Status:</label> 
        <select class="form-control" id="status" placeholder="PENDING"
